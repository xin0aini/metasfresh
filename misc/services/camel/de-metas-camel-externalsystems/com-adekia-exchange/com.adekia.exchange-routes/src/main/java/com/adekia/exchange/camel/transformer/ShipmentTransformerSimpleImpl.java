...
package com.adekia.exchange.camel.transformer;
...
@Component
@ConditionalOnSingleCandidate(ShipmentTransformer.class)
public class ShipmentTransformerSimpleImpl implements ShipmentTransformer
{
	@Override
