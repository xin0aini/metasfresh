...
@Component
public class AmazonOrdersRouteBuilder extends RouteBuilder {
    ...
    @Autowired
    public AmazonOrdersRouteBuilder(
    ...
    public void configure() throws Exception {
        ...
        //from("timer://foo?repeatCount=1")
                ...
                .log(LoggingLevel.INFO, "  RESPONSE : ${body}").process(getOrdersProcessor).id(GET_ORDERS_PROCESSOR_ID)
                .choice()
                .when(body().isNull())
