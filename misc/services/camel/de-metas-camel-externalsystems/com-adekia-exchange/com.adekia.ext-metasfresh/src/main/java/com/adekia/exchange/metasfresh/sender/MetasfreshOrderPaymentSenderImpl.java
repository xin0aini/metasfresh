...
public class MetasfreshOrderPaymentSenderImpl implements OrderPaymentSender
{
	private ProducerTemplate producerTemplate;

	@Autowired
	public MetasfreshOrderPaymentSenderImpl(ProducerTemplate producerTemplate) { this.producerTemplate=producerTemplate;}
